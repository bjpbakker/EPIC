//! This module contains the types used to track the content
//! for a mirrored repository
...
impl RepoContentElement {
    pub fn new(uri: rpki::uri::Rsync, data: Bytes) -> Self {
        RepoContentElement { uri, data }
    }
