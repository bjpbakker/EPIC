...
use crate::to_be_cleaned::fetch::{FetchMap, FetchMode, FetchSource, Fetcher};
...
pub struct Config {
    ...
    /// If true
    #[structopt(long = "rrdp-desynchronisation-check")]
    pub rrdp_desynchronisation_check: bool,
}
...
pub fn create_test_config(
    ...
    let config = Config {
        ...
        rrdp_desynchronisation_check: true,
    };
